<div class="d-flex flex-column flex-shrink-0 p-3 text-white" style="width: 280px; background: #212529">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="{{route('admin-main-panel-page')}}"
               class="{{ str_contains(request()->url(), '/admin/home') || str_contains(request()->url(),'user') ? 'active' : '' }} nav-link text-white"
               aria-current="page">
                Пользователи
            </a>
        </li>
