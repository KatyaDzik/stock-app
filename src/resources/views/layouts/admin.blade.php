...
<body>
<main style="display: flex; flex-wrap: nowrap; height:  100vh; max-height: 100vh; overflow-x: auto; overflow-y: hidden; background-color: rgba(0, 0, 0, .1);">
    <x-side-bar/>
    <div style="width: 80%; margin: 20px auto; ">
        <div style=" height: 80px; padding: 15px; background: white; border-radius: 10px;"><h2>@yield('page-title')</h2></div><br>
